...
while true do
    ...
    if showMenu == 0 then
        ...
        Font.print(fnt20, 726, 34, string.format("%02d:%02d", h, m), Colors.white)-- Draw time
        ...
        if showCat == 1 then
            Font.print(fnt22, 32, 34, lang_lines[1], Colors.white)--GAMES
        elseif showCat == 2 then
            Font.print(fnt22, 32, 34, lang_lines[2], Colors.white)--HOMEBREWS
        elseif showCat == 3 then
            Font.print(fnt22, 32, 34, lang_lines[3], Colors.white)--PSP
        elseif showCat == 4 then
            Font.print(fnt22, 32, 34, lang_lines[4], Colors.white)--PSX
        else
            Font.print(fnt22, 32, 34, lang_lines[5], Colors.white)--ALL
        end
        if Network.isWifiEnabled() then
    ...
    elseif showMenu == 3 then
        ...
        Graphics.fillRect(30, 930, 24, 496, Colors.darkalpha)-- Colors.bg
